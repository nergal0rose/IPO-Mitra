  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#0B0F1A' }}>
      <div className="text-center max-w-xs w-full px-6">
        ...
        <div className="text-[10px] mb-6" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>IPO Manager · Enter PIN</div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-3">
          ...
          <button onClick={handleBackspace} className="h-12 rounded-[7px] text-sm font-medium active:scale-95 transition-all" style={{ background: '#111827', border: '1px solid #1F2937', color: 'rgba(255, 255, 255, 0.8)' }}>←</button>
        ...
        <div className="text-[10px]" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Decrypts stored credentials</div>
      </div>
    </div>
  );
}
